        ...
        <div id="sidebar">
            ...
            <div class="content content-buku">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td valign="center">Siklus Air</td>
                            <td valign="center">Sains</td>
                            <td valign="center">John Doe</td>
                            <td valign="center">Rp. 10.000,00</td>
                            <td class="sampul-col-data">
                                <img src="https://i.pinimg.com/originals/f7/8c/b6/f78cb6367d8c78f9241475b957457914.jpg">
                            </td>
                            <td valign="center" class="action-col-data">
